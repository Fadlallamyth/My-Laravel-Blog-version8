        ...
        <div class="maincontainer">
            ...
            <div class="handredpercent">
                <div class="divforbtnnewitem">
                    <a href="{{ route('pages.create') }}" class="mybtn bluecolor">
                        <span> <i class="fa fa-plus"></i> صفحة جديدة </span>
                    </a>
                </div>
                <div class="divforbtndelete">
                    <button class="mybtn redcolor" id="delete_multiple_pages" disabled="disabled">
            ...
            <div class="postsnumbers">
                ...
                <div class="dropdowpubanddraf">
                    <ul>
                        <button onclick="window.location='{{ route('pages.index') }}'">
                                       ...
                                       <div class="admincontrolarea">
                                        <span class="fapadding">
                                            <span class="tomakehoverspan">
                                                <a href="{{ route('pages.edit', $page->id) }}"> <i class="fa fa-edit"></i>
                                                </a>
                                        ...
                                        <span class="fapadding">
                                            <span class="tomakehoverspan">
                                                <form class="one_page_delete"
                                                    data-route="{{ route('pages.destroy', $page->id) }}" id="submit_form"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
            ...
            <div class="nomorepages">
                @if($allpages->count() > 0 && !$allpages->hasMorePages())
