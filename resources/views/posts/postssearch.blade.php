...
@section('content')
    <div class="maincontent">
        <div class="maincontainer">
            ...
            {{-- ********************************************* --}}
            {{-- ********************************************* --}}
            @if ($allpostssearch->count() > 0)
                @foreach ($allpostssearch as $post)
                            ...
                            <div class="conttitletimechars">
                                <div class="titleandcontrolarea">
                                    ...
                                    <div class="controlarea">
                                        ...
                                        <span class="fapadding">
                                            <span class="tomakehoverspan">
                                            <form class="submitdeletform" data-route="{{ route('posts.destroy', $post->id) }}"
            ...
            @else
                <div class="handredpercent">
                    لا توجد نتائج عن : <b> {{ $postquery }} </b>
                </div>
            @endif

            <div class="handredpercent">
                {{ $allpostssearch->links() }}
            </div>
            <div class="nomorepages">
                @if($allpostssearch->count() > 0 && !$allpostssearch->hasMorePages())
